import { c as createServerRpc } from "./createServerRpc-T01JzlKW.js";
import { h as createServerFn, a as getRequest } from "./server-BfnmGY_x.js";
import { z } from "zod";
...
const checkAuthFn = createServerFn({
  ...
  const {
    getAccessToken
  } = await import("./cookies.server-CKml8kFV.js");
...
const terminateSession = createServerFn({
  ...
  const {
    getCookie,
    deleteCookie
  } = await import("./server-CUdO2dQu.js");
