...
// node_modules/@tanstack/react-start/dist/esm/useServerFn.js
var React = __toESM(require_react(), 1);
import { isRedirect as isRedirect2, useRouter } from "@tanstack/react-router";
function useServerFn(serverFn) {
  const router = useRouter();
  return React.useCallback(async (...args) => {
    try {
      const res = await serverFn(...args);
      if (isRedirect2(res)) throw res;
      return res;
    } catch (err) {
      if (isRedirect2(err)) {
...
// node_modules/@tanstack/start-fn-stubs/dist/esm/createIsomorphicFn.js
...
// node_modules/@tanstack/start-fn-stubs/dist/esm/envOnly.js
...
if (!globalObj[GLOBAL_STORAGE_KEY]) globalObj[GLOBAL_STORAGE_KEY] = new import_node_async_hooks.AsyncLocalStorage();
...
// node_modules/@tanstack/start-client-core/dist/esm/getStartContextServerOnly.js
...
var innerCreateCsrfMiddleware = (opts = {}) => {
  ...
  if (true) Object.defineProperty(middleware, csrfSymbol, { value: true });
  return middleware;
};
...
// node_modules/@tanstack/start-client-core/dist/esm/getRouterInstance.js
...
// node_modules/@tanstack/start-client-core/dist/esm/getGlobalStartContext.js
...
// node_modules/@tanstack/react-start-client/dist/esm/Hydrate.js
...
function ServerDynamicHydrate(props) {
  ...
  return (0, import_jsx_runtime.jsx)("div", {
    ...
    children: (0, import_jsx_runtime.jsx)(React2.Suspense, {
...
function Hydrate(props) {
  if (typeof props.when === "function") {
    if (isServer ?? typeof window === "undefined") return (0, import_jsx_runtime.jsx)(ServerDynamicHydrate, { ...props });
