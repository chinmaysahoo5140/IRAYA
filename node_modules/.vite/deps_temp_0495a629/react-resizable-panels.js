...
function on({
  ...
  const i = t !== void 0, r = "id" in o ? o.id : o.groupId, f = he(r, t ?? []), a = (0, import_react.useSyncExternalStore)(
    Xt,
    () => n.getItem(f),
    () => n.getItem(f)
  ...
  }, [s, r, t, n]), u = s ?? l, h = (0, import_react.useRef)(null), d = (0, import_react.useCallback)(() => {
    const c = h.current;
...
function Yt({
  ...
  const c = !!s, p = Le(s), m = Re({
    disabled: r
  }), v = (0, import_react.useRef)(null), b = Ce(v, f), {
    getPanelStyles: y,
    id: g,
    orientation: P,
    registerPanel: M,
...
function Qt({
  ...
  const s = Le(r), l = Re({
    disabled: n,
    disableDoubleClick: o
  }), [u, h] = (0, import_react.useState)({}), [d, S] = (0, import_react.useState)("inactive"), [z, c] = (0, import_react.useState)(false), p = (0, import_react.useRef)(null), m = Ce(p, i), {
    disableCursor: v,
    id: b,
    orientation: y,
    registerSeparator: g,
  ...
  }, [b, s, g, l]), (0, import_react.useEffect)(() => {
