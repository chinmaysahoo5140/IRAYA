import { i as createMiddleware, a as getRequest } from "./server-C1RKXgFD.js";
...
const requireSupabaseAuth = createMiddleware({ type: "function" }).server(
  async ({ next }) => {
    const { getCookie, setCookie, deleteCookie } = await import("./server-C8PAU-Ko.js");
    ...
    const { getClientIp, validateRequestTimestamp, writeSecurityEvent } = await import("./security.server-BRG0sDb-.js");
