import { b as createMiddleware, g as getRequest } from "./server-CUdO2dQu.mjs";
...
const requireSupabaseAuth = createMiddleware({ type: "function" }).server(
  async ({ next }) => {
    const { getCookie, setCookie, deleteCookie } = await import("./server-CUdO2dQu.mjs").then(function(n) {
      return n.e;
    });
