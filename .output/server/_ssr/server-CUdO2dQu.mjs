...
import { H as H3Event, t as toResponse, d as deleteCookie$1, s as setCookie$1, p as parseCookies } from "../_libs/h3-v2.mjs";
import { A as defineHandlerCallback, C as resolveManifestAssetLink, u as resolveManifestCssLink, k as rootRouteId, D as getNormalizedURL, E as getOrigin, F as normalizeSsrResponse, G as attachRouterServerSsrUtils, H as createSerializationAdapter, I as createRawStreamRPCPlugin, i as invariant, g as isNotFound, m as isRedirect, J as isResolvedRedirect, K as replaceSsrResponse, L as mergeHeaders, M as executeRewriteInput, N as stripSsrResponseBody, O as defaultSerovalPlugins, P as makeSerovalPlugin, s as getScriptPreloadAttrs, Q as getStylesheetHref, S as isSsrResponse, T as parseRedirect, x as transformPipeableStreamWithRouter, v as transformReadableStreamWithRouter } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DUtdR0_I.mjs");
...
const manifest = {
  "06d1c4397d8d80e59d6dd7a014172b24d07d1c906cfbffadfded6d2e704e3ac2": {
    functionName: "checkAuthFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "07995b0a058f02f571d729587a5a45876b02355e9fc2a6990793c510add58fe2": {
    functionName: "verify2faServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "0ddf57ac23192120a1e98e48f57343c6fe83e8a1ddcf5df54be83354a1f768ad": {
    functionName: "adminDeleteProduct_createServerFn_handler",
    importer: () => import("./admin.functions-R5BdntcH.mjs")
  },
  "17ca8a4339cbb04b419005d658d94f6ad96de94bdd053e2744cf2316606153aa": {
    functionName: "exportSecurityLogs_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  "1a6a134719f4b7d428fa66f37db345d640a7d613f26d0d5c860228812597bbb3": {
    functionName: "adminSecurityFeed_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  "1eebec19e04bfe989f1927af14cf4b054b098222893399fbc6b947df32f11ab0": {
    functionName: "adminSignImage_createServerFn_handler",
    importer: () => import("./admin.functions-R5BdntcH.mjs")
  },
  "27c6a8f3a486a1fe9e0ebb5e008b7ae011f79eeb90681c5496b9a9d09b6f70e4": {
    functionName: "listMySessions_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "2e4f317df8bf23d2870c4ea332074504c9569f356035cdcb9a83b33ff9adc18f": {
    functionName: "banIpServerFn_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  "3265360dd1bb8505874dca36fc08c120c489507fb549e4925a945a8286e7a79a": {
    functionName: "listMyOrders_createServerFn_handler",
    importer: () => import("./orders.functions-BcOSR3yx.mjs")
  },
  "35978e2419cc50dddeacc534bc89e7064e2b8ce08105e4feee0f7c83f6558128": {
    functionName: "signUpServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "38c174375dacd7a92e9e6050d22909885db1125a7f3c109afcf8e5a28f5e2942": {
    functionName: "listMyWishlist_createServerFn_handler",
    importer: () => import("./profile.functions-6bKKH4iy.mjs")
  },
  "4258783d4619a23f44b699b15ef558125dc21b709181a0a2aff93d15a7001a82": {
    functionName: "lockUserServerFn_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  "51ad93d03c52987e0e52d0164e41771f8765a8919d8a537367eaf795dff9b9d8": {
    functionName: "listProducts_createServerFn_handler",
    importer: () => import("./products.functions-B2nejerH.mjs")
  },
  "54530985819b491fd79f30ff32967dc944627d853bffa9017064b60497be17f7": {
    functionName: "exchangeCodeServerFn_createServerFn_handler",
    importer: () => import("./auth.callback-CZC7gg7L.mjs")
  },
  "5468b12d0dce68e830e883a63b1dd4aa4723696bd2a0eb3e4f2400fc3fcaff4e": {
  ...
  "598ff4ff45ff4238adf216e3a30144469c96c670c2c02a41b0509bab983d63a3": {
  ...
  "5e2c6a85ce8b9f3a92cd9b0a9b4d8f015d9ec2fa0b30eb31f8605ecef9f67199": {
    ...
    importer: () => import("./razorpay.functions-Aqb4puDw.mjs")
  },
  "70930d746d8a8f75bd06c967d8d1fb638cee57d9c00d197d2af2221a22cccda0": {
    functionName: "unbanIpServerFn_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  ...
  "75138d6bbf1699872b76cc40857535b1861c176f2f123a4c54f31bbad1ef836e": {
    functionName: "createShiprocketShipment_createServerFn_handler",
    importer: () => import("./shiprocket.functions-Mr4LL9FF.mjs")
  },
  "753bae9d6d697882a272e30d2f37b648143ad3f1643d55b1eaf3440c601ba4ff": {
    functionName: "terminateAllOtherSessions_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  ...
  "7fa8c91db179091ff6cb959e42809f454a284431c683e5e518b443a9cf593173": {
    functionName: "listMyAddresses_createServerFn_handler",
    importer: () => import("./profile.functions-6bKKH4iy.mjs")
  },
  "802683fc68d58adcbd14e37e9cea4215fce0391f5b8001fdebe9b23283676a24": {
    functionName: "toggleWishlist_createServerFn_handler",
    importer: () => import("./profile.functions-6bKKH4iy.mjs")
  },
  "81d621abc236bb8841e8fb237186b9ec0d2c6a365f27112db1c0d0bf89fd2254": {
    functionName: "confirm2faServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "8552c7bea139694beea39d17e69f323a972d63fd26947a65dd6b49554eb191c8": {
  ...
  "9a47419efc5357090981ea782cb467e0ba0f1997f9e04a3ffd50e525c202d583": {
    functionName: "terminateSession_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "a0d3c0fd56dc0ec1b203f8fc17c7f212b37ea6a3d6d9255b9a6f445828607116": {
    functionName: "signInWithPasswordServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  ...
  "addc11dc1fc307c89bfb435d49d20159f73b0c39d6063512ac456398fc06b87e": {
  ...
  "b407145077ca1f696815c0a6843d9d3ec6cd17b486611e8fb35e8e52b34e9e73": {
    functionName: "getMyOrder_createServerFn_handler",
    importer: () => import("./orders.functions-BcOSR3yx.mjs")
  },
  "be483e9e42c205c6c13091877a789f444afdfc857e317f374ec0a6ce52792cf0": {
    functionName: "setup2faServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "c54c041a51f0bd82d88c68f476e9fc7845294a7420241b76161a5bd003f4d5f9": {
    functionName: "changePasswordServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
  "cff4dae90332bd1231eb60786b6d8342f9fea9ea3fd8cb8e88f0dd0b49a7b83e": {
    functionName: "terminateSessionServerFn_createServerFn_handler",
    importer: () => import("./security-Di9oyco9.mjs")
  },
  "d0d3c71142e5936e54c42a3643c273b53a56fb29316e6fd26ccc3701adb52d6c": {
    functionName: "addAddress_createServerFn_handler",
    importer: () => import("./profile.functions-6bKKH4iy.mjs")
  },
  "d74efaed9d368b50c737966712aaf37f9bc30edca8be1eed754f166b39b69dcd": {
    functionName: "trackOrder_createServerFn_handler",
    importer: () => import("./orders.functions-BcOSR3yx.mjs")
  },
  "f8fc6907bb5e4e9589219b29e96be1223aa5d22c62252d4ff7be7670854d5f42": {
    functionName: "get2faStatusServerFn_createServerFn_handler",
    importer: () => import("./auth.functions-CVEcPtVj.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B46y8PhA.mjs").then((n) => n.P),
    import("./start-BOxqYYOi.mjs"),
...
const serverBfnmGY_x = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  H: HEADERS,
  S: StartServer,
  T: TSS_SERVER_FUNCTION,
  a: getRequest,
  b: defaultStreamHandler,
  ...
  h: createServerFn,
  i: createMiddleware,
  j: createCsrfMiddleware,
  k: getServerFnById,
  l: server,
  r: requestHandler,
  s: setCookie
});
const serverCUdO2dQu = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  HEADERS,
  StartServer,
  attachRouterServerSsrUtils,
