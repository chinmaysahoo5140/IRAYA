...
import { y as listMySessions, z as terminateSession, A as terminateAllOtherSessions } from "./router-B46y8PhA.mjs";
...
function SessionsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pt-32 pb-12 hairline-b", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 font-serif text-4xl md:text-5xl tracking-luxury", children: "Active Sessions" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6 grid lg:grid-cols-4 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "space-y-3 text-[11px] tracking-luxury uppercase", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/account/sessions", className: "block text-mute hover:text-charcoal", activeProps: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-2xl", children: "Manage login sessions" }),
          sessions && sessions.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => terminateOthersMut.mutate(), className: "text-[10px] tracking-luxury uppercase border border-charcoal px-4 py-2 hover:bg-charcoal hover:text-ivory transition-colors cursor-pointer", children: "Log out all other devices" })
        ] }),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-mute text-sm", children: "Loading sessions..." }) : !sessions || sessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-mute text-sm", children: "No active sessions found." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: sessions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-serif text-lg", children: [
                s.os || "Unknown OS",
                " · ",
                s.browser_name || "Unknown Browser"
              ] }),
              s.isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] tracking-luxury uppercase bg-charcoal text-ivory px-2 py-0.5", children: "Current session" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-mute uppercase tracking-wide-2 mt-1 space-y-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "IP Address: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-charcoal", children: s.ip_address || "unknown" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "Location: ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "Last Active: ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-charcoal", children: new Date(s.last_active).toLocaleString() })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => terminateMut.mutate(s.id), className: "text-[10px] tracking-luxury uppercase text-red-700 hover:text-red-900 cursor-pointer", children: s.isCurrent ? "Revoke current (Log out)" : "Terminate session" })
        ] }, s.id)) })
      ] })
    ] }) }),
