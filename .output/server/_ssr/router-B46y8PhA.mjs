...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, a as getServerFnById } from "./server-CUdO2dQu.mjs";
...
import { o as objectType, s as stringType, e as enumType, a as arrayType, n as numberType, b as booleanType } from "../_libs/zod.mjs";
...
function CartProvider({ children }) {
  ...
  const clear = reactExports.useCallback(() => persist([]), [persist]);
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-7xl text-foreground", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl text-foreground", children: "Page not found" }),
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-2xl text-foreground", children: "This page didn't load" }),
...
const $$splitComponentImporter$t = () => import("./track-DA1JxPTY.mjs");
const Route$x = createFileRoute("/track")({
  ssr: false,
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$s = () => import("./terms-BZzyDptA.mjs");
...
const $$splitComponentImporter$r = () => import("./returns-D8TyRy0r.mjs");
const Route$v = createFileRoute("/returns")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$q = () => import("./privacy-B_8b1s5e.mjs");
const Route$u = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$p = () => import("./faqs-R7W9kLsw.mjs");
const Route$t = createFileRoute("/faqs")({
  head: () => ({
    meta: [{
      title: "FAQs — IRAYA"
    }, {
...
const $$splitComponentImporter$o = () => import("./contact-DAfD-vsq.mjs");
...
const $$splitErrorComponentImporter$2 = () => import("./collection-C_a5jBFP.mjs");
const $$splitComponentImporter$n = () => import("./collection-Bn7tTJ3P.mjs");
const searchSchema = objectType({
  category: enumType(["bags", "footwear"]).optional()
});
const Route$r = createFileRoute("/collection")({
...
const $$splitComponentImporter$m = () => import("./checkout-jMB8UNkt.mjs");
...
const $$splitComponentImporter$l = () => import("./cart-crCrdWNw.mjs");
const Route$p = createFileRoute("/cart")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$k = () => import("./auth-DcPd95eq.mjs");
const Route$o = createFileRoute("/auth")({
  validateSearch: objectType({
    redirect: stringType().optional().refine((value) => !value || value.startsWith("/") && !value.startsWith("//"), {
...
const $$splitComponentImporter$j = () => import("./about-CEWvqsYC.mjs");
...
const $$splitErrorComponentImporter$1 = () => import("./index-C9WsNWqt.mjs");
const $$splitComponentImporter$h = () => import("./index-DLbtWOb-.mjs");
...
const $$splitNotFoundComponentImporter = () => import("./collection._slug-B3od-Z54.mjs");
const $$splitErrorComponentImporter = () => import("./collection._slug-Ctn0xdNC.mjs");
const $$splitComponentImporter$g = () => import("./collection._slug-BHGHApSP.mjs");
...
const $$splitComponentImporter$f = () => import("./checkout.success-S9hJAgK4.mjs");
const Route$j = createFileRoute("/checkout/success")({
  validateSearch: objectType({
    o: stringType().optional()
  }).parse,
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$e = () => import("./auth.callback-C9cHt_Qd.mjs");
...
const $$splitComponentImporter$d = () => import("./route-DWJeTODY.mjs");
...
const $$splitComponentImporter$c = () => import("./index-cuMKMq9f.mjs");
...
const $$splitComponentImporter$b = () => import("./index-Dvst5yyj.mjs");
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const { recordPaymentEvent, getClientIp } = await import("./security.server-BRG0sDb-.mjs");
          ...
          if (payment.id) {
            ...
            if (existingOrder) {
              if (existingOrder.id !== targetOrderId) {
                const { writeSecurityEvent } = await import("./security.server-BRG0sDb-.mjs");
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          const { sendEmail } = await import("./email.server-w0MXyg9U.mjs");
...
const Route$c = createFileRoute("/api/auth/verify-otp")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
          const { twilioClient, TWILIO_VERIFY_SERVICE_SID } = await import("./twilio-Cd-Q8XC8.mjs");
          const { supabaseAdmin } = await import("./client.server-ijnlFj_c.mjs");
          const {
            getClientIp,
            detectDeviceType,
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
          const { twilioClient, TWILIO_VERIFY_SERVICE_SID } = await import("./twilio-Cd-Q8XC8.mjs");
          const { getClientIp, checkRateLimit } = await import("./security.server-BRG0sDb-.mjs");
          let body;
          try {
            body = await request.json();
          } catch {
...
const $$splitComponentImporter$a = () => import("./security-BQhIAgcg.mjs");
...
const $$splitComponentImporter$9 = () => import("./products-BAoRwLgs.mjs");
...
const $$splitComponentImporter$8 = () => import("./orders-9FeC3lyL.mjs");
...
const $$splitComponentImporter$7 = () => import("./wishlist-DXuKIHf6.mjs");
...
const $$splitComponentImporter$6 = () => import("./sessions-n0lYQhr4.mjs");
...
const $$splitComponentImporter$5 = () => import("./security-BUvrqZRM.mjs");
...
const $$splitComponentImporter$4 = () => import("./profile-B4jCZxop.mjs");
const Route$4 = createFileRoute("/_authenticated/account/profile")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./orders-BeLerB1_.mjs");
const Route$3 = createFileRoute("/_authenticated/account/orders")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard-DdGYAH3H.mjs");
...
const $$splitComponentImporter$1 = () => import("./addresses-YPLP43Yh.mjs");
...
const $$splitComponentImporter = () => import("../_id-CDDW5D6b.mjs");
...
const TrackRoute = Route$x.update({
  id: "/track",
  path: "/track",
...
const ReturnsRoute = Route$v.update({
  id: "/returns",
  path: "/returns",
  getParentRoute: () => Route$y
});
const PrivacyRoute = Route$u.update({
  id: "/privacy",
  path: "/privacy",
  getParentRoute: () => Route$y
});
const FaqsRoute = Route$t.update({
  id: "/faqs",
  path: "/faqs",
  getParentRoute: () => Route$y
});
...
const CollectionRoute = Route$r.update({
  id: "/collection",
  path: "/collection",
  getParentRoute: () => Route$y
});
...
const CartRoute = Route$p.update({
  id: "/cart",
  path: "/cart",
  getParentRoute: () => Route$y
});
