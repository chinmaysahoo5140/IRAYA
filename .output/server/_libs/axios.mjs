...
import { r as requireForm_data, F as FormData$1 } from "./form-data.mjs";
import require$$1 from "crypto";
import require$$2 from "url";
import { r as requireDist, H as HttpsProxyAgent } from "./https-proxy-agent.mjs";
import require$$3 from "http";
import require$$4 from "https";
import http2 from "http2";
import require$$0 from "util";
import require$$1$1, { resolve } from "path";
import { r as requireFollowRedirects, f as followRedirects } from "./follow-redirects.mjs";
...
function requireAxios() {
  ...
  hasRequiredAxios = 1;
  var FormData$12 = requireForm_data();
  var crypto = require$$1;
  var url = require$$2;
  var HttpsProxyAgent2 = requireDist();
  var http = require$$3;
  var https = require$$4;
  var http2$1 = http2;
  var util = require$$0;
  var path = require$$1$1;
  var followRedirects2 = requireFollowRedirects();
  var zlib$1 = zlib;
  var stream$1 = stream;
  ...
  const {
    iterator: iterator2,
    toStringTag: toStringTag2
  } = Symbol;
  const hasOwnProperty2 = (({
    hasOwnProperty: hasOwnProperty3
  }) => (obj, prop) => hasOwnProperty3.call(obj, prop))(Object.prototype);
  const hasOwnInPrototypeChain2 = (thing, prop) => {
    let obj = thing;
    const seen = [];
    while (obj != null && obj !== Object.prototype) {
      ...
      seen.push(obj);
      if (hasOwnProperty2(obj, prop)) {
        return true;
      }
      obj = getPrototypeOf2(obj);
    }
    return false;
  };
  const getSafeProp2 = (obj, prop) => obj != null && hasOwnInPrototypeChain2(obj, prop) ? obj[prop] : void 0;
  ...
  const isPlainObject2 = (val) => {
    ...
    return (prototype3 === null || prototype3 === Object.prototype || getPrototypeOf2(prototype3) === null) && // Treat any genuine (non-Object.prototype-polluted) Symbol.toStringTag or
    // Symbol.iterator as evidence the value is a tagged/iterable type rather
    // than a plain object, while ignoring keys injected onto Object.prototype.
    !hasOwnInPrototypeChain2(val, toStringTag2) && !hasOwnInPrototypeChain2(val, iterator2);
  };
  ...
  const isReactNativeBlob2 = (value) => {
    return !!(value && typeof value.uri !== "undefined");
  };
  const isReactNative2 = (formData) => formData && typeof formData.getParts !== "undefined";
  ...
  const G2 = getGlobal2();
  const FormDataCtor2 = typeof G2.FormData !== "undefined" ? G2.FormData : void 0;
  const isFormData2 = (thing) => {
    if (!thing) return false;
    if (FormDataCtor2 && thing instanceof FormDataCtor2) return true;
    const proto = getPrototypeOf2(thing);
    if (!proto || proto === Object.prototype) return false;
    if (!isFunction$12(thing.append)) return false;
  ...
  const isContextDefined2 = (context) => !isUndefined2(context) && context !== _global2;
  function merge2(...objs) {
    ...
    const assignValue = (val, key) => {
      ...
      const targetKey = caseless && typeof key === "string" && findKey2(result, key) || key;
    ...
    for (let i = 0, l = objs.length; i < l; i++) {
      ...
      for (let j = 0; j < symbols.length; j++) {
        ...
        if (propertyIsEnumerable2.call(source, symbol)) {
  ...
  const inherits2 = (constructor, superConstructor, props, descriptors) => {
  ...
  const {
    propertyIsEnumerable: propertyIsEnumerable2
  } = Object.prototype;
  const isRegExp2 = kindOfTest2("RegExp");
  const reduceDescriptors2 = (obj, reducer) => {
  ...
  const freezeMethods2 = (obj) => {
    reduceDescriptors2(obj, (descriptor, name) => {
      if (isFunction$12(obj) && ["arguments", "caller", "callee"].includes(name)) {
        return false;
      }
  ...
  const toObjectSet2 = (arrayOrString, delimiter) => {
    const obj = {};
    const define = (arr) => {
      arr.forEach((value) => {
        obj[value] = true;
  ...
  const _setImmediate2 = ((setImmediateSupported, postMessageSupported) => {
    ...
    return postMessageSupported ? ((token, callbacks) => {
      _global2.addEventListener("message", ({
        source,
        data
      }) => {
  ...
  })(typeof setImmediate === "function", isFunction$12(_global2.postMessage));
  ...
  const isSafeIterable2 = (thing) => thing != null && hasOwnInPrototypeChain2(thing, iterator2) && isIterable2(thing);
  var utils$12 = {
    isArray: isArray2,
    ...
    isDate: isDate2,
    isFile: isFile2,
    isReactNativeBlob: isReactNativeBlob2,
    ...
    hasOwnInPrototypeChain: hasOwnInPrototypeChain2,
    getSafeProp: getSafeProp2,
    ...
    isSafeIterable: isSafeIterable2
  };
  const ignoreDuplicateOf2 = utils$12.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]);
  ...
  const INVALID_UNICODE_HEADER_VALUE_CHARS2 = new RegExp("[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+", "g");
  const INVALID_BYTE_STRING_HEADER_VALUE_CHARS2 = new RegExp("[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+", "g");
  function sanitizeValue2(value, invalidChars) {
    if (utils$12.isArray(value)) {
      return value.map((item) => sanitizeValue2(item, invalidChars));
    }
    return trimSPorHTAB2(String(value).replace(invalidChars, ""));
  }
  const sanitizeHeaderValue2 = (value) => sanitizeValue2(value, INVALID_UNICODE_HEADER_VALUE_CHARS2);
  const sanitizeByteStringHeaderValue2 = (value) => sanitizeValue2(value, INVALID_BYTE_STRING_HEADER_VALUE_CHARS2);
  function toByteStringHeaderObject2(headers) {
    const byteStringHeaders = /* @__PURE__ */ Object.create(null);
    utils$12.forEach(headers.toJSON(), (value, header) => {
      byteStringHeaders[header] = sanitizeByteStringHeaderValue2(value);
    });
    return byteStringHeaders;
  }
  const $internals2 = /* @__PURE__ */ Symbol("internals");
  ...
  function normalizeValue2(value) {
    ...
    return utils$12.isArray(value) ? value.map(normalizeValue2) : sanitizeHeaderValue2(String(value));
  }
  ...
  class AxiosHeaders3 {
    ...
    set(header, valueOrRewrite, rewrite) {
      ...
      if (utils$12.isPlainObject(header) || header instanceof this.constructor) {
      ...
      } else if (utils$12.isObject(header) && utils$12.isSafeIterable(header)) {
        ...
        for (const entry of header) {
          ...
          key = entry[0];
          if (utils$12.hasOwnProp(obj, key)) {
            dest = obj[key];
            obj[key] = utils$12.isArray(dest) ? [...dest, entry[1]] : [dest, entry[1]];
          } else {
            obj[key] = entry[1];
          }
        }
    ...
    get(header, parser) {
      ...
      if (header) {
        ...
        if (key) {
          ...
          if (utils$12.isFunction(parser)) {
            return parser.call(this, value, key);
          }
          if (utils$12.isRegExp(parser)) {
  ...
  utils$12.reduceDescriptors(AxiosHeaders3.prototype, ({
    value
  }, key) => {
  ...
  const REDACTED2 = "[REDACTED ****]";
  function hasOwnOrPrototypeToJSON2(source) {
    if (utils$12.hasOwnProp(source, "toJSON")) {
      return true;
    }
    let prototype3 = Object.getPrototypeOf(source);
    while (prototype3 && prototype3 !== Object.prototype) {
      if (utils$12.hasOwnProp(prototype3, "toJSON")) {
        return true;
      }
      prototype3 = Object.getPrototypeOf(prototype3);
    }
    return false;
  }
  function redactConfig2(config, redactKeys) {
    const lowerKeys = new Set(redactKeys.map((k) => String(k).toLowerCase()));
    const seen = [];
    const visit = (source) => {
      if (source === null || typeof source !== "object") return source;
      if (utils$12.isBuffer(source)) return source;
      if (seen.indexOf(source) !== -1) return void 0;
      if (source instanceof AxiosHeaders3) {
        source = source.toJSON();
      }
      seen.push(source);
      let result;
      if (utils$12.isArray(source)) {
        result = [];
        source.forEach((v, i) => {
          const reducedValue = visit(v);
          if (!utils$12.isUndefined(reducedValue)) {
            result[i] = reducedValue;
          }
        });
      } else {
        if (!utils$12.isPlainObject(source) && hasOwnOrPrototypeToJSON2(source)) {
          seen.pop();
          return source;
        }
        result = /* @__PURE__ */ Object.create(null);
        for (const [key, value] of Object.entries(source)) {
          const reducedValue = lowerKeys.has(key.toLowerCase()) ? REDACTED2 : visit(value);
          if (!utils$12.isUndefined(reducedValue)) {
  ...
  class AxiosError3 extends Error {
    static from(error, code, config, request, response, customProps) {
      const axiosError = new AxiosError3(error.message, code || error.code, config, request, response);
    ...
    toJSON() {
      ...
      const redactKeys = config && utils$12.hasOwnProp(config, "redact") ? config.redact : void 0;
      const serializedConfig = utils$12.isArray(redactKeys) && redactKeys.length > 0 ? redactConfig2(config, redactKeys) : utils$12.toJSONObject(config);
      return {
        // Standard
  ...
  AxiosError3.ECONNREFUSED = "ECONNREFUSED";
  ...
  AxiosError3.ERR_FORM_DATA_DEPTH_EXCEEDED = "ERR_FORM_DATA_DEPTH_EXCEEDED";
  const DEFAULT_FORM_DATA_MAX_DEPTH2 = 100;
  ...
  function toFormData2(obj, formData, options) {
    ...
    formData = formData || new (FormData$12 || FormData)();
    ...
    const maxDepth = options.maxDepth === void 0 ? DEFAULT_FORM_DATA_MAX_DEPTH2 : options.maxDepth;
    ...
    function stringifyWithDepthLimit(value, depth) {
      ...
      return JSON.stringify(value, function limitDepth(_key, currentValue) {
        if (!utils$12.isObject(currentValue)) {
          return currentValue;
        }
    ...
    function defaultVisitor(value, key, path2) {
      let arr = value;
      if (utils$12.isReactNative(formData) && utils$12.isReactNativeBlob(value)) {
        formData.append(renderKey2(path2, key, dots), convertValue(value));
        return false;
      }
    ...
    function build(value, path2, depth = 0) {
      ...
      utils$12.forEach(value, function each(el, key) {
        const result = !(utils$12.isUndefined(el) || el === null) && visitor.call(formData, el, utils$12.isString(key) ? key.trim() : key, path2, exposedHelpers);
        if (result === true) {
  ...
  function buildURL2(url2, params, options) {
    ...
    const _options = utils$12.isFunction(options) ? {
      serialize: options
    } : options;
    const _encode = utils$12.getSafeProp(_options, "encode") || encode2;
    const serializeFn = utils$12.getSafeProp(_options, "serialize");
    let serializedParams;
    if (serializeFn) {
      serializedParams = serializeFn(params, _options);
    } else {
      serializedParams = utils$12.isURLSearchParams(params) ? params.toString() : new AxiosURLSearchParams2(params, _options).toString(_encode);
    }
    if (serializedParams) {
  ...
  const DIGIT2 = "0123456789";
  const ALPHABET2 = {
    DIGIT: DIGIT2,
    ALPHA: ALPHA2,
    ALPHA_DIGIT: ALPHA2 + ALPHA2.toUpperCase() + DIGIT2
  };
  const generateString2 = (size = 16, alphabet = ALPHABET2.ALPHA_DIGIT) => {
    let str = "";
    const {
      length
    } = alphabet;
  ...
  const MAX_DEPTH2 = DEFAULT_FORM_DATA_MAX_DEPTH2;
  function throwIfDepthExceeded2(index) {
    if (index > MAX_DEPTH2) {
      throw new AxiosError3("FormData field is too deeply nested (" + index + " levels). Max depth: " + MAX_DEPTH2, AxiosError3.ERR_FORM_DATA_DEPTH_EXCEEDED);
    }
  }
  function parsePropPath2(name) {
    ...
    while ((match = pattern.exec(name)) !== null) {
      throwIfDepthExceeded2(path2.length);
    ...
    function buildPath(path2, value, target, index) {
      ...
      if (isLast) {
        if (utils$12.hasOwnProp(target, name)) {
          target[name] = utils$12.isArray(target[name]) ? target[name].concat(value) : [target[name], value];
        } else {
          target[name] = value;
        }
        return !isNumericKey;
      }
      if (!utils$12.hasOwnProp(target, name) || !utils$12.isObject(target[name])) {
        target[name] = [];
      }
  ...
  const own2 = (obj, key) => obj != null && utils$12.hasOwnProp(obj, key) ? obj[key] : void 0;
  ...
  const defaults2 = {
    ...
    transformRequest: [function transformRequest2(data, headers) {
      ...
      if (isObjectPayload) {
        ...
        if ((isFileList3 = utils$12.isFileList(data)) || contentType.indexOf("multipart/form-data") > -1) {
          const env = own2(this, "env");
          const _FormData = env && env.FormData;
          return toFormData2(isFileList3 ? {
            "files[]": data
    ...
    transformResponse: [function transformResponse2(data) {
      ...
      if (data && utils$12.isString(data) && (forcedJSONParsing && !responseType || JSONRequested)) {
        ...
        try {
          ...
          if (strictJSONParsing) {
            if (e.name === "SyntaxError") {
              throw AxiosError3.from(e, AxiosError3.ERR_BAD_RESPONSE, this, null, own2(this, "response"));
            }
            throw e;
          }
        }
  ...
  utils$12.forEach(["delete", "get", "head", "post", "put", "patch", "query"], (method) => {
    defaults2.headers[method] = {};
  });
  function transformData2(fns, response) {
    const config = this || defaults2;
    const context = response || config;
    const headers = AxiosHeaders3.from(context.headers);
  ...
  class CanceledError3 extends AxiosError3 {
    /**
    ...
    constructor(message, config, request) {
      super(message == null ? "canceled" : message, AxiosError3.ERR_CANCELED, config, request);
  ...
  function settle2(resolve2, reject, response) {
    ...
    if (!response.status || !validateStatus2 || validateStatus2(response.status)) {
      ...
      reject(new AxiosError3("Request failed with status code " + response.status, response.status >= 400 && response.status < 500 ? AxiosError3.ERR_BAD_REQUEST : AxiosError3.ERR_BAD_RESPONSE, response.config, response.request, response));
    }
  }
  ...
  const malformedHttpProtocol2 = /^https?:(?!\/\/)/i;
  const httpProtocolControlCharacters2 = /[\t\n\r]/g;
  function stripLeadingC0ControlOrSpace2(url2) {
    let i = 0;
  ...
  function normalizeURLForProtocolCheck2(url2) {
    return stripLeadingC0ControlOrSpace2(url2).replace(httpProtocolControlCharacters2, "");
  }
  function assertValidHttpProtocolURL2(url2, config) {
    if (typeof url2 === "string" && malformedHttpProtocol2.test(normalizeURLForProtocolCheck2(url2))) {
      throw new AxiosError3('Invalid URL: missing "//" after protocol', AxiosError3.ERR_INVALID_URL, config);
    }
  }
  function buildFullPath2(baseURL, requestedURL, allowAbsoluteUrls, config) {
    assertValidHttpProtocolURL2(requestedURL, config);
    let isRelativeUrl = !isAbsoluteURL2(requestedURL);
    if (baseURL && (isRelativeUrl || allowAbsoluteUrls === false)) {
      assertValidHttpProtocolURL2(baseURL, config);
  ...
  const VERSION2 = "1.18.0";
  function parseProtocol2(url2) {
    const match = /^([-+\w]{1,25}):(?:\/\/)?/.exec(url2);
    return match && match[1] || "";
  }
  const DATA_URL_PATTERN2 = /^([^,;]+\/[^,;]+)?((?:;[^,;=]+=[^,;]+)*)(;base64)?,([\s\S]*)$/;
  ...
  const kInternals2 = /* @__PURE__ */ Symbol("internals");
  class AxiosTransformStream2 extends stream$1.Transform {
    constructor(options) {
      options = utils$12.toFlatObject(options, {
        maxRate: 0,
        chunkSize: 64 * 1024,
        ...
        return !utils$12.isUndefined(source[prop]);
      });
      super({
  ...
  const readBlob2 = async function* (blob) {
    if (blob.stream) {
      yield* blob.stream();
  ...
  const BOUNDARY_ALPHABET2 = platform2.ALPHABET.ALPHA_DIGIT + "-_";
  const textEncoder2 = typeof TextEncoder === "function" ? new TextEncoder() : new util.TextEncoder();
  const CRLF2 = "\r\n";
  const CRLF_BYTES2 = textEncoder2.encode(CRLF2);
  const CRLF_BYTES_COUNT2 = 2;
  class FormDataPart2 {
    constructor(name, value) {
      const {
        escapeName
      } = this.constructor;
      const isStringValue = utils$12.isString(value);
      ...
      if (isStringValue) {
        ...
        headers += `Content-Type: ${safeType}${CRLF2}`;
      }
    ...
    async *encode() {
      ...
      if (utils$12.isTypedArray(value)) {
        yield value;
      } else {
        yield* readBlob2(value);
      }
      yield CRLF_BYTES2;
    }
  ...
  const formDataToStream2 = (form, headersHandler, options) => {
    const {
      tag = "form-data-boundary",
      size = 25,
      boundary = tag + "-" + platform2.generateString(size, BOUNDARY_ALPHABET2)
    } = options || {};
    if (!utils$12.isFormData(form)) {
    ...
    contentLength = utils$12.toFiniteNumber(contentLength);
  ...
  class ZlibHeaderTransformStream2 extends stream$1.Transform {
  ...
  class Http2Sessions2 {
    ...
    getSession(authority, options) {
      ...
      const session = http2$1.connect(authority, options);
      let removed;
      let timer;
      const removeSession = () => {
        if (removed) {
  ...
  const callbackify2 = (fn, reducer) => {
    return utils$12.isAsyncFn(fn) ? function(...args) {
      const cb = args.pop();
  ...
  const LOOPBACK_HOSTNAMES2 = /* @__PURE__ */ new Set(["localhost", "0.0.0.0"]);
  const isIPv4Loopback2 = (host) => {
    const parts = host.split(".");
    if (parts.length !== 4) return false;
    if (parts[0] !== "127") return false;
    return parts.every((p) => /^\d+$/.test(p) && Number(p) >= 0 && Number(p) <= 255);
  };
  const isIPv6ZeroGroup2 = (group) => /^0{1,4}$/.test(group);
  const isIPv6Unspecified2 = (host) => {
    if (host === "::") return true;
    ...
    if (compressionIndex !== -1) {
      ...
      return explicitGroups < 8 && leftGroups.every(isIPv6ZeroGroup2) && rightGroups.every(isIPv6ZeroGroup2);
    }
    const groups = host.split(":");
    return groups.length === 8 && groups.every(isIPv6ZeroGroup2);
  };
  const isIPv6Loopback2 = (host) => {
    if (host === "::1") return true;
    const v4MappedDotted = host.match(/^::ffff:(\d+\.\d+\.\d+\.\d+)$/i);
    if (v4MappedDotted) return isIPv4Loopback2(v4MappedDotted[1]);
  ...
  const isLoopback2 = (host) => {
    if (!host) return false;
    if (LOOPBACK_HOSTNAMES2.has(host)) return true;
    if (isIPv4Loopback2(host)) return true;
    if (isIPv6Unspecified2(host)) return true;
    return isIPv6Loopback2(host);
  };
  const DEFAULT_PORTS2 = {
    http: 80,
    https: 443,
    ws: 80,
    wss: 443,
  ...
  const parseNoProxyEntry2 = (entry) => {
    let entryHost = entry;
    let entryPort = 0;
  ...
  const IPV4_MAPPED_DOTTED_RE2 = /^(?:::|(?:0{1,4}:){1,4}:|(?:0{1,4}:){5})ffff:(\d+\.\d+\.\d+\.\d+)$/i;
  const IPV4_MAPPED_HEX_RE2 = /^(?:::|(?:0{1,4}:){1,4}:|(?:0{1,4}:){5})ffff:([0-9a-f]{1,4}):([0-9a-f]{1,4})$/i;
  const unmapIPv4MappedIPv62 = (host) => {
    if (typeof host !== "string" || host.indexOf(":") === -1) return host;
    const dotted = host.match(IPV4_MAPPED_DOTTED_RE2);
    if (dotted) return dotted[1];
    const hex = host.match(IPV4_MAPPED_HEX_RE2);
    if (hex) {
  ...
  const normalizeNoProxyHost2 = (hostname) => {
    if (!hostname) {
      return hostname;
    }
    ...
    return unmapIPv4MappedIPv62(hostname.replace(/\.+$/, ""));
  };
  function shouldBypassProxy2(location) {
    let parsed;
    try {
    ...
    const hostname = normalizeNoProxyHost2(parsed.hostname.toLowerCase());
    return noProxy.split(/[\s,]+/).some((entry) => {
      if (!entry) {
        return false;
      }
      let [entryHost, entryPort] = parseNoProxyEntry2(entry);
      entryHost = normalizeNoProxyHost2(entryHost);
      if (!entryHost) {
        return false;
      }
      ...
      return hostname === entryHost || isLoopback2(hostname) && isLoopback2(entryHost);
    });
  }
  ...
  const isHexDigit2 = (charCode) => charCode >= 48 && charCode <= 57 || charCode >= 65 && charCode <= 70 || charCode >= 97 && charCode <= 102;
  const isPercentEncodedByte2 = (str, i, len) => i + 2 < len && isHexDigit2(str.charCodeAt(i + 1)) && isHexDigit2(str.charCodeAt(i + 2));
  function estimateDataURLDecodedBytes2(url2) {
    ...
    if (isBase64) {
      ...
      for (let i = 0; i < len; i++) {
        if (body.charCodeAt(i) === 37 && i + 2 < len) {
          ...
          const isHex = isHexDigit2(a) && isHexDigit2(b);
          if (isHex) {
            effectiveLen -= 2;
            i += 2;
          }
    ...
    for (let i = 0, len = body.length; i < len; i++) {
      ...
      if (c === 37 && isPercentEncodedByte2(body, i, len)) {
        bytes += 1;
        i += 2;
      } else if (c < 128) {
        bytes += 1;
  ...
  const zstdOptions2 = {
    flush: zlib$1.constants.ZSTD_e_flush,
    finishFlush: zlib$1.constants.ZSTD_e_flush
  };
  const isBrotliSupported2 = utils$12.isFunction(zlib$1.createBrotliDecompress);
  const isZstdSupported2 = utils$12.isFunction(zlib$1.createZstdDecompress);
  const ACCEPT_ENCODING2 = "gzip, compress, deflate" + (isBrotliSupported2 ? ", br" : "");
  const ACCEPT_ENCODING_WITH_ZSTD2 = ACCEPT_ENCODING2 + (isZstdSupported2 ? ", zstd" : "");
  const {
    http: httpFollow2,
    https: httpsFollow2
  } = followRedirects2;
  const isHttps2 = /https:?/;
  const FORM_DATA_CONTENT_HEADERS$12 = ["content-type", "content-length"];
  function setFormDataHeaders$12(headers, formHeaders, policy) {
    if (policy !== "content-only") {
      headers.set(formHeaders);
      return;
    }
    Object.entries(formHeaders).forEach(([key, val]) => {
      if (FORM_DATA_CONTENT_HEADERS$12.includes(key.toLowerCase())) {
        headers.set(key, val);
      }
    });
  }
  const kAxiosSocketListener2 = /* @__PURE__ */ Symbol("axios.http.socketListener");
  const kAxiosCurrentReq2 = /* @__PURE__ */ Symbol("axios.http.currentReq");
  const kAxiosInstalledTunnel2 = /* @__PURE__ */ Symbol("axios.http.installedTunnel");
  const tunnelingAgentCache2 = /* @__PURE__ */ new Map();
  const tunnelingAgentCacheUser2 = /* @__PURE__ */ new WeakMap();
  function getTunnelingAgent2(agentOptions, userHttpsAgent) {
    const key = agentOptions.protocol + "//" + agentOptions.hostname + ":" + (agentOptions.port || "") + "#" + (agentOptions.auth || "");
    const cache = userHttpsAgent ? tunnelingAgentCacheUser2.get(userHttpsAgent) || tunnelingAgentCacheUser2.set(userHttpsAgent, /* @__PURE__ */ new Map()).get(userHttpsAgent) : tunnelingAgentCache2;
  ...
  const supportedProtocols2 = platform2.protocols.map((protocol) => {
    return protocol + ":";
  });
  const decodeURIComponentSafe$12 = (value) => {
    if (!utils$12.isString(value)) {
      return value;
    }
    try {
  ...
  const flushOnFinish2 = (stream2, [throttled, flush]) => {
    stream2.on("end", flush).on("error", flush);
    return throttled;
  };
  const http2Sessions2 = new Http2Sessions2();
  function dispatchBeforeRedirect2(options, responseDetails, requestDetails) {
  ...
  function stripMatchingHeaders2(headers, sensitiveSet) {
    if (!headers) {
      return;
    }
  ...
  function isSameOriginRedirect2(redirectOptions, requestDetails) {
    if (!requestDetails) {
      return false;
    }
    try {
  ...
  function setProxy2(options, configProxy, location, isRedirect, configHttpsAgent) {
    let proxy = configProxy;
    if (!proxy && proxy !== false) {
      const proxyUrl = getProxyForUrl2(location);
      if (proxyUrl) {
        if (!shouldBypassProxy2(location)) {
    ...
    if (isRedirect && options.agent && options.agent[kAxiosInstalledTunnel2]) {
      options.agent = void 0;
    }
    if (proxy) {
      const isProxyURL = proxy instanceof URL;
      const readProxyField = (key) => isProxyURL || utils$12.hasOwnProp(proxy, key) ? proxy[key] : void 0;
      const proxyUsername = readProxyField("username");
      const proxyPassword = readProxyField("password");
      let proxyAuth = utils$12.hasOwnProp(proxy, "auth") ? proxy.auth : void 0;
      if (proxyUsername) {
        proxyAuth = (proxyUsername || "") + ":" + (proxyPassword || "");
      }
      if (proxyAuth) {
        const authIsObject = typeof proxyAuth === "object";
        const authUsername = authIsObject && utils$12.hasOwnProp(proxyAuth, "username") ? proxyAuth.username : void 0;
        const authPassword = authIsObject && utils$12.hasOwnProp(proxyAuth, "password") ? proxyAuth.password : void 0;
        const validProxyAuth = Boolean(authUsername || authPassword);
        if (validProxyAuth) {
          proxyAuth = (authUsername || "") + ":" + (authPassword || "");
        } else if (authIsObject) {
          throw new AxiosError3("Invalid proxy authorization", AxiosError3.ERR_BAD_OPTION, {
            proxy
          });
        }
      }
      const targetIsHttps = isHttps2.test(options.protocol);
      if (targetIsHttps) {
        if (!(configHttpsAgent instanceof HttpsProxyAgent2)) {
          ...
          const tunnelingAgent = getTunnelingAgent2(agentOptions, configHttpsAgent);
    ...
    options.beforeRedirects.proxy = function beforeRedirect(redirectOptions) {
      setProxy2(redirectOptions, configProxy, redirectOptions.href, true, configHttpsAgent);
    };
  }
  const isHttpAdapterSupported2 = typeof process !== "undefined" && utils$12.kindOf(process) === "process";
  const wrapAsync2 = (asyncExecutor) => {
  ...
  const resolveFamily2 = ({
    address,
    family
  }) => {
    if (!utils$12.isString(address)) {
  ...
  const buildAddressEntry2 = (address, family) => resolveFamily2(utils$12.isObject(address) ? address : {
    address,
    family
  });
  const http2Transport2 = {
    request(options, cb) {
      ...
      utils$12.forEach(headers, (header, name) => {
  ...
  var httpAdapter3 = isHttpAdapterSupported2 && function httpAdapter4(config) {
    return wrapAsync2(async function dispatchHttpRequest(resolve2, reject, onDone) {
      const own3 = (key) => utils$12.getSafeProp(config, key);
      const transitional2 = own3("transitional") || transitionalDefaults2;
      let data = own3("data");
      ...
      if (lookup) {
        const _lookup = callbackify2(lookup, (value) => utils$12.isArray(value) ? value : [value]);
        lookup = (hostname, opt, cb) => {
          _lookup(hostname, opt, (err, arg0, arg1) => {
            if (err) {
              return cb(err);
            }
            const addresses = utils$12.isArray(arg0) ? arg0.map((addr) => buildAddressEntry2(addr)) : [buildAddressEntry2(arg0, arg1)];
      ...
      function createTimeoutError() {
        ...
        return new AxiosError3(timeoutErrorMessage, transitional2.clarifyTimeoutError ? AxiosError3.ETIMEDOUT : AxiosError3.ECONNABORTED, config, req);
      }
      ...
      const fullPath = buildFullPath2(own3("baseURL"), own3("url"), own3("allowAbsoluteUrls"), config);
      ...
      if (protocol === "data:") {
        if (maxContentLength > -1) {
          ...
          if (estimated > maxContentLength) {
            return reject(new AxiosError3("maxContentLength size of " + maxContentLength + " exceeded", AxiosError3.ERR_BAD_RESPONSE, config));
          }
        }
        let convertedData;
        if (method !== "GET") {
        ...
        try {
          convertedData = fromDataURI2(own3("url"), responseType === "blob", {
        ...
        if (responseType === "text") {
          ...
          if (!responseEncoding || responseEncoding === "utf8") {
            convertedData = utils$12.stripBOM(convertedData);
          }
      ...
      const headers = AxiosHeaders3.from(config.headers).normalize();
      ...
      if (utils$12.isSpecCompliantForm(data)) {
        const userBoundary = headers.getContentType(/boundary=([-_\w\d]{10,70})/i);
        data = formDataToStream2(data, (formHeaders) => {
          headers.set(formHeaders);
        }, {
          tag: `axios-${VERSION2}-boundary`,
          boundary: userBoundary && userBoundary[1] || void 0
        });
      } else if (utils$12.isFormData(data) && utils$12.isFunction(data.getHeaders) && data.getHeaders !== Object.prototype.getHeaders) {
        setFormDataHeaders$12(headers, data.getHeaders(), own3("formDataHeaderPolicy"));
      ...
      } else if (utils$12.isBlob(data) || utils$12.isFile(data)) {
        data.size && headers.setContentType(data.type || "application/octet-stream");
        headers.setContentLength(data.size || 0);
        data = stream$1.Readable.from(readBlob2(data));
      } else if (data && !utils$12.isStream(data)) {
        if (Buffer.isBuffer(data)) ;
        else if (utils$12.isArrayBuffer(data)) {
          data = Buffer.from(new Uint8Array(data));
        } else if (utils$12.isString(data)) {
      ...
      const contentLength = utils$12.toFiniteNumber(headers.getContentLength());
      if (utils$12.isArray(maxRate)) {
      ...
      if (data && (onUploadProgress || maxUploadRate)) {
        if (!utils$12.isStream(data)) {
          data = stream$1.Readable.from(data, {
            objectMode: false
          });
        }
        data = stream$1.pipeline([data, new AxiosTransformStream2({
          maxRate: utils$12.toFiniteNumber(maxUploadRate)
        })], utils$12.noop);
      ...
      if (configAuth) {
        const username = utils$12.getSafeProp(configAuth, "username") || "";
        const password = utils$12.getSafeProp(configAuth, "password") || "";
        auth = username + ":" + password;
      }
      if (!auth && (parsed.username || parsed.password)) {
        const urlUsername = decodeURIComponentSafe$12(parsed.username);
        const urlPassword = decodeURIComponentSafe$12(parsed.password);
        auth = urlUsername + ":" + urlPassword;
      }
      auth && headers.delete("authorization");
      let path$1;
      try {
        path$1 = buildURL2(parsed.pathname + parsed.search, own3("params"), own3("paramsSerializer")).replace(/^\?/, "");
      } catch (err) {
        const customErr = new Error(err.message);
        customErr.config = config;
        customErr.url = own3("url");
        customErr.exists = true;
        return reject(customErr);
      }
      headers.set("Accept-Encoding", utils$12.hasOwnProp(transitional2, "advertiseZstdAcceptEncoding") && transitional2.advertiseZstdAcceptEncoding === true ? ACCEPT_ENCODING_WITH_ZSTD2 : ACCEPT_ENCODING2, false);
      const options = Object.assign(/* @__PURE__ */ Object.create(null), {
        path: path$1,
        method,
        headers: toByteStringHeaderObject2(headers),
        agents: {
          http: httpAgent,
          https: httpsAgent
        },
      ...
      !utils$12.isUndefined(lookup) && (options.lookup = lookup);
      const socketPath = own3("socketPath");
      if (socketPath) {
        if (typeof socketPath !== "string") {
          return reject(new AxiosError3("socketPath must be a string", AxiosError3.ERR_BAD_OPTION_VALUE, config));
        }
        ...
        setProxy2(options, own3("proxy"), protocol + "//" + parsed.hostname + (parsed.port ? ":" + parsed.port : "") + options.path, false, httpsAgent);
      }
      let transport;
      ...
      if (isHttp2) {
        ...
        if (configTransport) {
          ...
          if (sensitiveHeaders != null) {
            if (!utils$12.isArray(sensitiveHeaders)) {
              return reject(new AxiosError3("sensitiveHeaders must be an array of strings", AxiosError3.ERR_BAD_OPTION_VALUE, config));
            }
            const sensitiveSet = /* @__PURE__ */ new Set();
            for (const header of sensitiveHeaders) {
              if (!utils$12.isString(header)) {
                return reject(new AxiosError3("sensitiveHeaders must be an array of strings", AxiosError3.ERR_BAD_OPTION_VALUE, config));
              }
            ...
            if (sensitiveSet.size) {
              ...
              options.beforeRedirects.sensitiveHeaders = function beforeRedirectSensitiveHeaders(redirectOptions, requestDetails) {
                if (!isSameOriginRedirect2(redirectOptions, requestDetails)) {
                  stripMatchingHeaders2(redirectOptions.headers, sensitiveSet);
                }
              };
            }
          }
      ...
      req = transport.request(options, function handleResponse(res) {
        ...
        const streams = [res];
        const responseLength = utils$12.toFiniteNumber(res.headers["content-length"]);
        if (onDownloadProgress || maxDownloadRate) {
          const transformStream = new AxiosTransformStream2({
            maxRate: utils$12.toFiniteNumber(maxDownloadRate)
          });
          onDownloadProgress && transformStream.on("progress", flushOnFinish2(transformStream, progressEventDecorator2(responseLength, progressEventReducer2(asyncDecorator2(onDownloadProgress), true, 3))));
        ...
        if (decompress !== false && res.headers["content-encoding"]) {
          ...
          switch ((res.headers["content-encoding"] || "").toLowerCase()) {
            ...
            case "compress":
            case "x-compress":
              streams.push(zlib$1.createUnzip(zlibOptions2));
              delete res.headers["content-encoding"];
              break;
            case "deflate":
              streams.push(new ZlibHeaderTransformStream2());
              streams.push(zlib$1.createUnzip(zlibOptions2));
              delete res.headers["content-encoding"];
              break;
            case "br":
              if (isBrotliSupported2) {
                streams.push(zlib$1.createBrotliDecompress(brotliOptions2));
                delete res.headers["content-encoding"];
              }
              break;
            case "zstd":
              if (isZstdSupported2) {
                streams.push(zlib$1.createZstdDecompress(zstdOptions2));
                delete res.headers["content-encoding"];
              }
              break;
          }
        }
        responseStream = streams.length > 1 ? stream$1.pipeline(streams, utils$12.noop) : streams[0];
        const response = {
          status: res.statusCode,
          statusText: res.statusMessage,
          headers: new AxiosHeaders3(res.headers),
          config,
          request: lastRequest
        };
        if (responseType === "stream") {
            ...
            async function* enforceMaxContentLength() {
              ...
              for await (const chunk of source) {
                ...
                if (totalResponseBytes > limit) {
                  throw new AxiosError3("maxContentLength size of " + limit + " exceeded", AxiosError3.ERR_BAD_RESPONSE, config, lastRequest);
                }
                yield chunk;
              }
            }
          ...
          responseStream.on("data", function handleStreamData(chunk) {
            ...
            if (maxContentLength > -1 && totalResponseBytes > maxContentLength) {
              ...
              abort(new AxiosError3("maxContentLength size of " + maxContentLength + " exceeded", AxiosError3.ERR_BAD_RESPONSE, config, lastRequest));
            }
          });
          responseStream.on("aborted", function handlerStreamAborted() {
            ...
            const err = new AxiosError3("stream has been aborted", AxiosError3.ERR_BAD_RESPONSE, config, lastRequest, response);
            responseStream.destroy(err);
            reject(err);
          });
          responseStream.on("error", function handleStreamError(err) {
            if (rejected) return;
            reject(AxiosError3.from(err, null, config, lastRequest, response));
          });
          responseStream.on("end", function handleStreamEnd() {
            try {
              ...
              if (responseType !== "arraybuffer") {
                ...
                if (!responseEncoding || responseEncoding === "utf8") {
                  responseData = utils$12.stripBOM(responseData);
                }
              }
      ...
      req.on("socket", function handleRequestSocket(socket) {
        ...
        if (!socket[kAxiosSocketListener2]) {
          ...
          socket[kAxiosSocketListener2] = true;
        }
        socket[kAxiosCurrentReq2] = req;
        boundSockets.add(socket);
      });
      req.once("close", function clearCurrentReq() {
        clearConnectPhaseTimer();
        for (const socket of boundSockets) {
          if (socket[kAxiosCurrentReq2] === req) {
            socket[kAxiosCurrentReq2] = null;
          }
        }
        boundSockets.clear();
      });
      if (own3("timeout")) {
        ...
        if (Number.isNaN(timeout)) {
          abort(new AxiosError3("error trying to parse `config.timeout` to int", AxiosError3.ERR_BAD_OPTION_VALUE, config, req));
          return;
        }
      ...
      if (utils$12.isStream(data)) {
        ...
        if (maxBodyLength > -1 && !transportEnforcesMaxBodyLength) {
          ...
          let bytesSent = 0;
          uploadStream = stream$1.pipeline([data, new stream$1.Transform({
            transform(chunk, _enc, cb) {
              bytesSent += chunk.length;
              if (bytesSent > limit) {
                return cb(new AxiosError3("Request body larger than maxBodyLength limit", AxiosError3.ERR_BAD_REQUEST, config, req));
              }
              cb(null, chunk);
            }
          })], utils$12.noop);
    ...
    // Standard browser envs support document.cookie
    {
      ...
      read(name) {
        ...
        for (let i = 0; i < cookies3.length; i++) {
          const cookie = cookies3[i].replace(/^\s+/, "");
  ...
  const headersToObject2 = (thing) => thing instanceof AxiosHeaders3 ? {
    ...thing
  } : thing;
  function mergeConfig2(config1, config2) {
    ...
    function getMergedTransitionalOption(prop) {
      const transitional2 = utils$12.hasOwnProp(config2, "transitional") ? config2.transitional : void 0;
      if (!utils$12.isUndefined(transitional2)) {
        if (utils$12.isPlainObject(transitional2)) {
          if (utils$12.hasOwnProp(transitional2, prop)) {
      ...
      const transitional1 = utils$12.hasOwnProp(config1, "transitional") ? config1.transitional : void 0;
      if (utils$12.isPlainObject(transitional1) && utils$12.hasOwnProp(transitional1, prop)) {
        return transitional1[prop];
      }
      return void 0;
    }
    function mergeDirectKeys(a, b, prop) {
      if (utils$12.hasOwnProp(config2, prop)) {
        return getMergedValue(a, b);
      } else if (utils$12.hasOwnProp(config1, prop)) {
        return getMergedValue(void 0, a);
      }
    }
    const mergeMap = {
    ...
    utils$12.forEach(Object.keys({
      ...config1,
      ...config2
    }), function computeConfigValue(prop) {
      if (prop === "__proto__" || prop === "constructor" || prop === "prototype") return;
      const merge3 = utils$12.hasOwnProp(mergeMap, prop) ? mergeMap[prop] : mergeDeepProperties;
      const a = utils$12.hasOwnProp(config1, prop) ? config1[prop] : void 0;
      const b = utils$12.hasOwnProp(config2, prop) ? config2[prop] : void 0;
      const configValue = merge3(a, b, prop);
      utils$12.isUndefined(configValue) && merge3 !== mergeDirectKeys || (config[prop] = configValue);
    });
    if (utils$12.hasOwnProp(config2, "validateStatus") && utils$12.isUndefined(config2.validateStatus) && getMergedTransitionalOption("validateStatusUndefinedResolves") === false) {
      if (utils$12.hasOwnProp(config1, "validateStatus")) {
  ...
  const FORM_DATA_CONTENT_HEADERS2 = ["content-type", "content-length"];
  ...
  const encodeUTF8$12 = (str) => encodeURIComponent(str).replace(/%([0-9A-F]{2})/gi, (_, hex) => String.fromCharCode(parseInt(hex, 16)));
  function resolveConfig2(config) {
    const newConfig = mergeConfig2({}, config);
    const own3 = (key) => utils$12.hasOwnProp(newConfig, key) ? newConfig[key] : void 0;
    ...
    newConfig.url = buildURL2(buildFullPath2(baseURL, url2, allowAbsoluteUrls, newConfig), own3("params"), own3("paramsSerializer"));
    if (auth) {
      const username = utils$12.getSafeProp(auth, "username") || "";
      const password = utils$12.getSafeProp(auth, "password") || "";
      headers.set("Authorization", "Basic " + btoa(username + ":" + (password ? encodeUTF8$12(password) : "")));
    }
    if (utils$12.isFormData(data)) {
      if (platform2.hasStandardBrowserEnv || platform2.hasStandardBrowserWebWorkerEnv || utils$12.isReactNative(data)) {
        headers.setContentType(void 0);
      } else if (utils$12.isFunction(data.getHeaders)) {
        setFormDataHeaders2(headers, data.getHeaders(), own3("formDataHeaderPolicy"));
      }
    }
    if (platform2.hasStandardBrowserEnv) {
      if (utils$12.isFunction(withXSRFToken)) {
        withXSRFToken = withXSRFToken(newConfig);
      }
      const shouldSendXSRF = withXSRFToken === true || withXSRFToken == null && isURLSameOrigin2(newConfig.url);
      if (shouldSendXSRF) {
  ...
  var xhrAdapter2 = isXHRAdapterSupported2 && function(config) {
    return new Promise(function dispatchXhrRequest(resolve2, reject) {
      ...
      function onloadend() {
        ...
        const responseHeaders = AxiosHeaders3.from("getAllResponseHeaders" in request && request.getAllResponseHeaders());
      ...
      request.ontimeout = function handleTimeout() {
        ...
        reject(new AxiosError3(timeoutErrorMessage, transitional2.clarifyTimeoutError ? AxiosError3.ETIMEDOUT : AxiosError3.ECONNABORTED, config, request));
        done();
        request = null;
      };
      requestData === void 0 && requestHeaders.setContentType(null);
      if ("setRequestHeader" in request) {
        utils$12.forEach(toByteStringHeaderObject2(requestHeaders), function setRequestHeader(val, key) {
  ...
  const composeSignals2 = (signals, timeout) => {
    ...
    let timer = timeout && setTimeout(() => {
      timer = null;
      onabort(new AxiosError3(`timeout of ${timeout}ms exceeded`, AxiosError3.ETIMEDOUT));
    }, timeout);
    const unsubscribe = () => {
      if (!signals) {
        return;
  ...
  const readStream2 = async function* (stream2) {
  ...
  const trackStream2 = (stream2, chunkSize, onProgress, onFinish) => {
    const iterator3 = readBytes2(stream2, chunkSize);
    let bytes = 0;
    let done;
    let _onFinish = (e) => {
      if (!done) {
  ...
  const encodeUTF82 = (str) => encodeURIComponent(str).replace(/%([0-9A-F]{2})/gi, (_, hex) => String.fromCharCode(parseInt(hex, 16)));
  const decodeURIComponentSafe2 = (value) => {
    if (!utils$12.isString(value)) {
      return value;
    }
    try {
  ...
  const maybeWithAuthCredentials2 = (url2) => {
  ...
  const factory2 = (env) => {
    const globalObject = utils$12.global !== void 0 && utils$12.global !== null ? utils$12.global : globalThis;
    const {
    ...
    const supportsResponseStream = isResponseSupported && isReadableStreamSupported && test2(() => utils$12.isReadableStream(new Response("").body));
    const resolvers = {
    ...
    return async (config) => {
      ...
      const hasMaxContentLength = utils$12.isNumber(maxContentLength) && maxContentLength > -1;
      const hasMaxBodyLength = utils$12.isNumber(maxBodyLength) && maxBodyLength > -1;
      const own3 = (key) => utils$12.hasOwnProp(config, key) ? config[key] : void 0;
      ...
      const maxBodyLengthError = () => new AxiosError3("Request body larger than maxBodyLength limit", AxiosError3.ERR_BAD_REQUEST, config, request);
      try {
        let auth = void 0;
        const configAuth = own3("auth");
        if (configAuth) {
        ...
        if (maybeWithAuthCredentials2(url2)) {
        ...
        if (hasMaxContentLength && typeof url2 === "string" && url2.startsWith("data:")) {
          const estimated = estimateDataURLDecodedBytes2(url2);
          if (estimated > maxContentLength) {
            throw new AxiosError3("maxContentLength size of " + maxContentLength + " exceeded", AxiosError3.ERR_BAD_RESPONSE, config, request);
          }
        }
        ...
        const mustEnforceStreamBody = hasMaxBodyLength && (utils$12.isReadableStream(data) || utils$12.isStream(data));
        const trackRequestStream = (stream2, onProgress, flush) => trackStream2(stream2, DEFAULT_CHUNK_SIZE2, (loadedBytes) => {
        ...
        if (supportsRequestStream && method !== "get" && method !== "head" && (onUploadProgress || mustEnforceStreamBody)) {
          ...
          if (requestContentLength !== 0 || mustEnforceStreamBody) {
            ...
            if (_request.body) {
              const [onProgress, flush] = onUploadProgress && progressEventDecorator2(requestContentLength, progressEventReducer2(asyncDecorator2(onUploadProgress))) || [];
          ...
          throw new AxiosError3("Stream request bodies are not supported by the current fetch implementation", AxiosError3.ERR_NOT_SUPPORT, config, request);
        }
        ...
        const resolvedOptions = {
          ...
          headers: toByteStringHeaderObject2(headers.normalize()),
          body: data,
          duplex: "half",
        ...
        const responseHeaders = AxiosHeaders3.from(response.headers);
        if (hasMaxContentLength) {
          const declaredLength = utils$12.toFiniteNumber(responseHeaders.getContentLength());
        ...
        if (supportsResponseStream && response.body && (onDownloadProgress || hasMaxContentLength || isStreamResponse && unsubscribe)) {
          ...
          const responseContentLength = utils$12.toFiniteNumber(responseHeaders.getContentLength());
          const [onProgress, flush] = onDownloadProgress && progressEventDecorator2(responseContentLength, progressEventReducer2(asyncDecorator2(onDownloadProgress), true)) || [];
          let bytesRead = 0;
          ...
          response = new Response(trackStream2(response.body, DEFAULT_CHUNK_SIZE2, onChunkProgress, () => {
            flush && flush();
        ...
        unsubscribe && unsubscribe();
        if (composedSignal && composedSignal.aborted && composedSignal.reason instanceof AxiosError3) {
        ...
        if (err && err.name === "TypeError" && /Load failed|fetch/i.test(err.message)) {
          throw Object.assign(new AxiosError3("Network Error", AxiosError3.ERR_NETWORK, config, request, err && err.response), {
            cause: err.cause || err
          });
        }
        throw AxiosError3.from(err, err && err.code, config, request, err && err.response);
      }
    };
  };
  ...
  function getAdapter2(adapters3, config) {
    ...
    if (!adapter) {
      ...
      throw new AxiosError3(`There is no suitable adapter to dispatch the request ` + s, "ERR_NOT_SUPPORT");
    }
    return adapter;
  }
  var adapters2 = {
  ...
  function dispatchRequest2(config) {
    ...
    config.headers = AxiosHeaders3.from(config.headers);
    config.data = transformData2.call(config, config.transformRequest);
    if (["post", "put", "patch"].indexOf(config.method) !== -1) {
      config.headers.setContentType("application/x-www-form-urlencoded", false);
    }
    const adapter = adapters2.getAdapter(config.adapter || defaults2.adapter, config);
    return adapter(config).then(function onAdapterResolution(response) {
      throwIfCancellationRequested2(config);
      config.response = response;
      try {
        response.data = transformData2.call(config, config.transformResponse, response);
      } finally {
        delete config.response;
      }
      response.headers = AxiosHeaders3.from(response.headers);
      return response;
      ...
      if (!isCancel2(reason)) {
        ...
        if (reason && reason.response) {
          ...
          try {
            reason.response.data = transformData2.call(config, config.transformResponse, reason.response);
          } finally {
            delete config.response;
          }
          reason.response.headers = AxiosHeaders3.from(reason.response.headers);
        }
      }
  ...
  validators$12.transitional = function transitional2(validator3, version, message) {
    function formatMessage(opt, desc) {
      return "[Axios v" + VERSION2 + "] Transitional option '" + opt + "'" + desc + (message ? ". " + message : "");
    }
    return (value, opt, opts) => {
      if (validator3 === false) {
        throw new AxiosError3(formatMessage(opt, " has been removed" + (version ? " in " + version : "")), AxiosError3.ERR_DEPRECATED);
      }
  ...
  function assertOptions2(options, schema, allowUnknown) {
    ...
    while (i-- > 0) {
      const opt = keys[i];
      const validator3 = Object.prototype.hasOwnProperty.call(schema, opt) ? schema[opt] : void 0;
      if (validator3) {
  ...
  class Axios3 {
    ...
    _request(configOrUrl, config) {
      ...
      let contextHeaders = headers && utils$12.merge(headers.common, headers[config.method]);
      headers && utils$12.forEach(["delete", "get", "head", "post", "put", "patch", "query", "common"], (method) => {
        delete headers[method];
      });
      config.headers = AxiosHeaders3.concat(contextHeaders, headers);
      ...
      this.interceptors.request.forEach(function unshiftRequestInterceptors(interceptor) {
        ...
        const transitional3 = config.transitional || transitionalDefaults2;
    ...
    getUri(config) {
      config = mergeConfig2(this.defaults, config);
      const fullPath = buildFullPath2(config.baseURL, config.url, config.allowAbsoluteUrls, config);
  ...
  utils$12.forEach(["delete", "get", "head", "options"], function forEachMethodNoData2(method) {
    Axios3.prototype[method] = function(url2, config) {
      return this.request(mergeConfig2(config || {}, {
        method,
        url: url2,
        data: config && utils$12.hasOwnProp(config, "data") ? config.data : void 0
      }));
    };
  });
  utils$12.forEach(["post", "put", "patch", "query"], function forEachMethodWithData2(method) {
  ...
  function createInstance2(defaultConfig) {
    ...
    const instance = bind2(Axios3.prototype.request, context);
    utils$12.extend(instance, Axios3.prototype, context, {
      allOwnKeys: true
    });
    utils$12.extend(instance, context, null, {
      allOwnKeys: true
    });
  ...
  const axios2 = createInstance2(defaults2);
  axios2.Axios = Axios3;
  axios2.CanceledError = CanceledError3;
  axios2.CancelToken = CancelToken3;
  ...
  axios2.AxiosHeaders = AxiosHeaders3;
  ...
  axios2.HttpStatusCode = HttpStatusCode2;
...
class Http2Sessions {
  ...
  getSession(authority, options) {
    ...
    if (authoritySessions) {
      ...
      for (let i = 0; i < len; i++) {
        const [sessionHandle, sessionOptions] = authoritySessions[i];
        if (!sessionHandle.destroyed && !sessionHandle.closed && require$$0.isDeepStrictEqual(sessionOptions, options)) {
          return sessionHandle;
        }
      }
    }
...
const httpAdapter = isHttpAdapterSupported && function httpAdapter2(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve$1, reject, onDone) {
    ...
    if (utils$1.isSpecCompliantForm(data)) {
      ...
      if (!headers.hasContentLength()) {
        try {
          const knownLength = await require$$0.promisify(data.getLength).call(data);
          Number.isFinite(knownLength) && knownLength >= 0 && headers.setContentLength(knownLength);
        } catch (e) {
        }
      }
